...
import { Mail, Chrome, Linkedin, Facebook } from 'lucide-react';
  ...
  const handleSocialLogin = async (providerName: 'google' | 'linkedin' | 'facebook') => {
    ...
    switch (providerName) {
      case 'google':
        ...
        break;
      case 'linkedin':
        // Note: LinkedIn via Firebase requires custom OAuth setup in Firebase Console
        provider = new OAuthProvider('linkedin.com');
        break;
      case 'facebook':
         // Note: Facebook via Firebase requires setup in Firebase Console
